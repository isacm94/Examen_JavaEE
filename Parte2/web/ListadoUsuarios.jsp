...
<%
    ...
    if (request.getAttribute("cadena") != null) {//*******PROBLEMA 7************
        cadena = (String) request.getAttribute("cadena");
    }
...
<html>
    ...
    <center>
        ...
        <%-- PAGINADOR --%>   
         <% if (cadena.equals("")) {//PROBLEMA 7 --> SOLO MUESTRA EL PAGINADOR CUANDO NO SE ESTÁ BUSCANDO POR CADENA%>
        <p>      
            <% if (inicio != pagActual) {%>
