...
public class ListadoUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("cadena") == null) {
            cadena = "";
            tabla = GetTabla(inicio);
            numUsuarios = GetNumUsuarios();
        } else {//************** PROBLEMA 7 ******** Si se ha introducido una cadena
            cadena = request.getParameter("cadena");
            tabla = GetTabla(cadena);
            numUsuarios = GetNumUsuarios(cadena);
        }
        ...
        request.setAttribute("cadena", cadena);//*************** PROBLEMA 7***************
    ...
    /************************ PROBLEMA 7 ***********************/
    protected String GetTabla(String cadena) {
        String tabla = "";
    ...
    protected int GetNumUsuarios(String cadena) {
