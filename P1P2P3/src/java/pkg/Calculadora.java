...
public class Calculadora extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int rdo_division = 0;
        String mensaje = "";
        if (operacion.equals("dividir") && esEntero(n_1) && esEntero(n_2) && error_n2.equals("")) {
            rdo_division = (int) n_1 / (int) n_2;
            rdo = String.valueOf(rdo_division);
            mensaje = "(La operación es con enteros)";
        } //No se ha producido ningún error
        else if (error_n1.equals("") && error_n2.equals("")) {
        ...
        request.setAttribute("rdo_division", rdo_division);
